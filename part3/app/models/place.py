...
class Place(BaseModel):
    ...
    def to_dict(self):
        ...
        # Convert owner to owner_id for API representation
        if hasattr(self, 'owner') and self.owner:
            place_dict['owner_id'] = self.owner.id
            del place_dict['owner']  # Remove the full owner object
        
        # Convert lists to counts or IDs
        place_dict['review_count'] = len(self.reviews)
        place_dict['amenity_count'] = len(self.amenities)
